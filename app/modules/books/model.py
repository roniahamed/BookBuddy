...
class Book(Base):
    ...
    front_cover_image = Column(String(500), nullable=True, comment="URL to front cover image")
    front_cover_image_url = Column(String(500), nullable=True, comment="External URL to front cover image")
    back_cover_image = Column(String(500), nullable=True, comment="URL to back cover image")
